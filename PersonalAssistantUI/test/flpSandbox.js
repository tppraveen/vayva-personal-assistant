		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Line and Labour Standard",
									"targetURL": "#PersonalAssistantUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PersonalAssistantUI-display": {
								"semanticObject": "PersonalAssistantUI",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=PersonalAssistantUI",
									"url": sap.ui.require.toUrl("PersonalAssistantUI")
								}
							}
						}
					}
